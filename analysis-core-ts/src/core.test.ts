...
import { activeCombination, analyzeFrame2D, analyzeTruss2D, type StructuralModel } from "./index.js";

const baseModel: Pick<StructuralModel, "version" | "projectInfo" | "units" | "loadCases" | "loadCombinations" | "activeCombination" | "results"> = {
  version: 1,
...
function trussModel(): StructuralModel {
  return {
    ...baseModel,
...
function frameModel(): StructuralModel {
  return {
    ...baseModel,
    materials: [{ id: "steel", name: "Steel", eKgM2: 2.05e10 }],
